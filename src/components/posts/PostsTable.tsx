            ...
            posts.map(post => (
              <TableRow key={post.id}>
                ...
                <TableCell>
                  ...
                  {(can(Permission.EDIT_ALL_POSTS) || canOwn(Permission.EDIT_OWN_POSTS, post.authorId)) && (
                    <Button variant="link" asChild>
                      <Link href={`/posts/${post.slug}/edit`}>Edit</Link>
                    </Button>
                  )}
                  {(can(Permission.DELETE_ALL_POSTS) || canOwn(Permission.DELETE_OWN_POSTS, post.authorId)) && (
                    <Button
                      variant="link"
